...
export const metadata: Metadata = {
  ...
  description: "Canada-wide Rewear shopping delivery and Montréal local free-delivery policy.",
};
    ...
    <main className="shipping-policy-page">
      ...
      <article className="legal-policy">
        <div className="policy-hero">
          ...
          <h1>Canada-wide shopping.</h1>
          <p>Customers can shop from anywhere in Canada. Local delivery pricing depends on the delivery address.</p>
        </div>

        <section className="policy-highlight"><PackageCheck/><div><h2>Canada-wide availability</h2><p>{policy.canadaWideEnabled ? "Rewear shopping is available for delivery across Canada." : "Canada-wide delivery is temporarily disabled."}</p></div></section>
        ...
        <section><h2>Address verification</h2><p>The final delivery option and fee must be determined from the delivery address entered during checkout. A city name alone is not enough to guarantee free local delivery.</p></section>
        <section><h2>Remote and oversized shipments</h2><p>Carrier availability, oversized parcels and remote destinations may require a different shipping service or additional review before payment is finalized.</p></section>
