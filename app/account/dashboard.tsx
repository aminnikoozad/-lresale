  ...
  return <Dialog open={open} onOpenChange={setOpen}>
    ...
    <DialogContent className="request-dialog">
      ...
      <form className="request-form" action={createCollectionRequest}>
        ...
        <div className="request-form-footer"><Button type="submit">Submit collection request</Button><small className="payment-note">Submitting a request does not guarantee free pickup approval.</small></div>
      </form>
    </DialogContent>
  </Dialog>;
}
